...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.1, nms=dict(type='nms', iou_thr=0.5), max_per_img=40)  # 修改之前是[0.05, 40]
...
log_level = 'INFO'
work_dir = '/media/ser248/3rd/WangCK/Data/work_dirs/KAIST/Expirement2/v16_bfp_add_saliencyMap_3'
# work_dir = '/home/wangck/WangCK/Data/work_dirs/KAIST/Expirement2/v16_bfp_add_saliencyMap_3'
load_from = None
resume_from = '/media/ser248/3rd/WangCK/Data/work_dirs/KAIST/Expirement2/v16_bfp_add_saliencyMap_3/latest.pth'
workflow = [('train', 1)]
