...
log_level = 'INFO'
work_dir = '/media/ser248/3rd/WangCK/Data/work_dirs/kaist/mul_libra_faster_rcnn_v16_fpn_add_kaist'
# work_dir = '/home/wangck/WangCK/Data/work_dirs/mul_libra_faster_rcnn_v16_fpn_add_kaist'
load_from = None
resume_from = None
workflow = [('train', 1)]
