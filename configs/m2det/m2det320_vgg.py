...
model = dict(
    ...
    bbox_head=dict(
        type='SSDHead',
        input_size=input_size,
        in_channels=(2048, 2048, 2048, 2048, 2048, 2048),
        num_classes=81,
        anchor_strides=(8, 16, 32, 64, 107, 320),
        basesize_ratio_range=(0.08, 1.05),
...
log_level = 'INFO'
work_dir = './work_dirs/m2det320_vgg'
load_from = None
resume_from = None
workflow = [('train', 1)]
