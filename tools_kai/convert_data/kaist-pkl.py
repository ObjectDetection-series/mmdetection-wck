...
def main():
    ...
    img_all_paths = [osp.join(img_dir, img_name.replace('.txt', '.jpg').replace('/I', '/visible/I')) for img_name in
                     img_all_names]
    ...
    img_test_paths = [osp.join(img_dir, img_name.replace('.txt', '.jpg').replace('/I', '/visible/I')) for img_name in
                      img_test_names]
